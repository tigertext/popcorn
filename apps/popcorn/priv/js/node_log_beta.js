...
function rgbToHsv(e,t,n){e=e/255,t=t/255,n=n/255;var r=Math.max(e,t,n),i=Math.min(e,t,n);var s,o,u=r;var a=r-i;o=r==0?0:a/r;if(r==i){s=0}else{switch(r){case e:s=(t-n)/a+(t<n?6:0);break;case t:s=(n-e)/a+2;break;case n:s=(e-t)/a+4;break}s/=6}return[s,o,u]}function hsvToRgb(e,t,n){var r,i,s;var o=Math.floor(e*6);var u=e*6-o;var a=n*(1-t);var f=n*(1-u*t);var l=n*(1-(1-u)*t);switch(o%6){case 0:r=n,i=l,s=a;break;case 1:r=f,i=n,s=a;break;case 2:r=a,i=n,s=l;break;case 3:r=a,i=f,s=n;break;case 4:r=l,i=a,s=n;break;case 5:r=n,i=a,s=f;break}return[r*255,i*255,s*255]}
...
$(document).ready(function() {
 ...
 timeChart = d3.select("#visualization-container").append("svg")
    ...
    if (totalSeverityCount) {
      if (!severityChartPath) {
        severityChartPath = severityChart.selectAll('path').data(pie(severityCounts))
                                         .enter().append('path')
                                         .attr('fill', function(d, i) { return SEVERITY_COLORS[i]; })
                                         .attr('d', arc);
      } else {
  ...
  flushData = function() {
    ...
    var nowKey = Math.floor(new Date().getTime() / 1000) - timestampOffset;
    while (nowKey % 5) { nowKey--; };
    nowKey = nowKey / 5;
    ...
    severitiesByPeriod[nowKey] = lastSeverity;

    // pull the roles
    var lastRole = rolesByPeriod[nowKey] || {};
    ...
    rolesByPeriod[nowKey] = lastRole;

    // pull the nodes
    var lastNode = nodesByPeriod[nowKey] || {};
